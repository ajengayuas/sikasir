...
@section('title', 'Report Kredit')

@section('content_header','Detail Data Kredit')
            ...
            <div class="modal-body">
                <form action="" id="produkform" name="produkform" class="form-horizontal" method="post">
                    ...
                    <table align="right">
                        ...
                        <tr>
                            <td><label id="lblkurang" name="lblkurang">Kekurangan</label></td>
                            <td> <label> : </label> </td>
                ...
                "drawCallback": function(settings) {
                    ...
                    if (dataku == [] || dataku == '') {
                        ...
                        if (dataku[0].dp == 0) {
                            ...
                            $('#dp').text('DP');
                            $('#lbldp').text('DP');
                            $('#hisbayar').text(formatter.format(blunas));
                            $('#titik').text(':');
